...
public class Profile_PastEvents_Activity extends AppCompatActivity {

    private String ObjectIdOfUser;
    List<HashMap<String,String>> aList = new ArrayList<HashMap<String,String>>();
    Calendar calendar = Calendar.getInstance();
    private boolean isCurrentDateGreaterThanParseStartDate = false;
    private boolean isCurrentDateGreaterThanParseEndDate = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent intent = new Intent(Profile_PastEvents_Activity.this, EventDescriptionActivity.class);
                ...
                if (e == null) {
                    ...
                    for (int i = 0; i < len; i++) {
                        ...
                        if (pEvent_Creater.equals(ObjectIdOfUser)) {
                            ...
                            if (isCurrentDateGreaterThanParseStartDate && isCurrentDateGreaterThanParseEndDate) {

                                //return them default values
                                isCurrentDateGreaterThanParseStartDate = false;
                                isCurrentDateGreaterThanParseEndDate = false;
    ...
    private void compareParseStartDateAndCurrentDate(ParseObject p) {
        ...
        try {
            ...
            if (parseStartDate.compareTo(currentDate) < 0) {
                ...
                isCurrentDateGreaterThanParseStartDate = true;
    ...
    private void compareParseEndDateAndCurrentDate(ParseObject p) {
        ...
        try {
            ...
            if (parseEndDate.compareTo(currentDate) < 0) {
                ...
                isCurrentDateGreaterThanParseEndDate = true;
                System.out.println("current date is greater");
            }
        } catch (java.text.ParseException e1) {
            e1.printStackTrace();
